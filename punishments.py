...
async def tempmute(ctx, user, tc, reason="Не указана", ignore_ndm=False):
    try:
        ...
        role = await ctx.guild.create_role(name = "HP-MUTED", permissions = discord.Permissions.none(), colour = discord.Colour(0x675D7D))
...
**Модератор:** H-Protect#1444 (<@356737308898099201>)
